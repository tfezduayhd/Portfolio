...
export default function ProjectCard({ project, language }: ProjectCardProps) {
  return (
    <Link
      ...
      className="group block rounded-2xl glass-panel p-5 smooth-lift hover:border-[rgba(var(--accent-rose),0.2)]"
    >
      ...
      <p className="text-sm text-white/30 mb-3 leading-relaxed">{project.description}</p>
