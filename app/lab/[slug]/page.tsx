...
export default async function LabDetailPage({ params }: Props) {
  ...
  return (
    <SectionWrapper>
      <Link href="/lab" className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-neutral-300 transition-colors mb-10">
        ← Back to Lab
      </Link>
      ...
      <header className="mb-10">
        ...
        <h1 className="text-4xl font-bold text-neutral-100 mb-3">{item.title}</h1>
